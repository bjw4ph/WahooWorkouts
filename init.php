...
<html>
	...
	<body>
		...
		$result = $db->query("create table siteUser (siteUser__id int primary key not null, Name char(30) not null, Email char(60) not null, Address char(30) not null, City char(30) not null, State char(30) not null, ZipCode char(30) not null, Password char(30) not null, Type char(30) not null)") or die ("Invalid: " . $db->error);
		...
		foreach($trainers as $trainerstring){
			...
			if (isset($trainer[6])){
				$query1 = "insert into siteUser values ('$counter', '$trainer[0]', '$trainer[1]', '$trainer[2]', '$trainer[3]', '$trainer[4]', '$trainer[5]', 'password', 'trainer')";
				...
				$query1 = "insert into siteUser values ('$counter', '$trainer[0]', '$trainer[1]', '$trainer[2]', '$trainer[3]', '$trainer[4]', '$trainer[5]', 'password', 'user')";
				$db->query($query1) or die("Invalid Insert " .$db->error);
			}
		}
      ...
      ?>
      <a href="index.php">Continue to Home Page</a> <br>
