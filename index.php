							...
							<section id="intro" class="container">
								...
								<footer>
									<ul class="actions">
										...
										<li><a href="aboutus.php" class="button alt big">Learn About Us</a></li>
									</ul>
								</footer>
							</section>
								...
								<!-- Portfolio -->
									<section>
										...
										<div class="row">
											<div class="4u 12u(mobile)">
												<section class="box">
													<a href="trainer.php?id=1" class="image featured"><img src="images/pic02.jpg" alt="" /></a>
													<header>
											...
											<div class="4u 12u(mobile)">
												<section class="box">
													<a href="trainer.php?id=2" class="image featured"><img src="images/pic03.jpg" alt="" /></a>
													<header>
											...
											<div class="4u 12u(mobile)">
												<section class="box">
													<a href="trainer.php?id=3" class="image featured"><img src="images/pic04.jpg" alt="" /></a>
													<header>
